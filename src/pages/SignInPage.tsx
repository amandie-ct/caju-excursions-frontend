  ...
  return (
    <section className="px-6 py-10 lg:px-10 lg:py-14">
      <div className="mx-auto max-w-5xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-card lg:grid lg:grid-cols-[minmax(0,0.9fr)_minmax(18rem,1.1fr)] lg:gap-10">
        <div className="mb-10 rounded-[1.75rem] bg-slate-950 p-8 text-white lg:mb-0">
          <PageIntro
            eyebrow="Sign In"
            title="Access your bookings and continue the checkout flow"
            description="The authentication routes are now part of the app shell, so account screens no longer live outside the main navigation."
          />
          <p className="mt-10 text-sm leading-7 text-slate-300">
            Don’t have an account yet?{' '}
            <Link to="/sign-up" className="font-semibold text-amber-400">
              Create one on the sign up route
            </Link>
            .
          </p>
        </div>
